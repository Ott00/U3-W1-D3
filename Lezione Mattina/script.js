...
var TestFat = /** @class */ (function () {
    function TestFat(_ragSoc, _pIva, _righeFat, _totPrice, id) {
        ...
        this.totPrice = this.getTotaleFat();
    }
...
var fattura1 = new TestFat("Azienda XYZ", "01245789654", [
    { id: 1, codArt: "A123", descrizione: "Articolo 1", qty: 2, unitPrice: 30 },
    { id: 2, codArt: "B123", descrizione: "Articolo 2", qty: 3, unitPrice: 20 },
    { id: 3, codArt: "C123", descrizione: "Articolo 3", qty: 2, unitPrice: 80 },
    { id: 3, codArt: "C123", descrizione: "Articolo 3", qty: 2, unitPrice: 10 }
], 0, 1);
